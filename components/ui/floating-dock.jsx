  ...
  return (
    (<div className={cn("relative block md:hidden", className)}>
            ...
            {items.map((item, idx) => (
              <motion.div
                ...
                <Link
                  ...
                  key={item.title}
                  className={cn(
                    "h-10 w-10 rounded-full bg-neutral-900 flex items-center justify-center",
      ...
      <button
        ...
        className="h-10 w-10 rounded-full bg-neutral-800 flex items-center justify-center cursor-pointer">
  ...
  return (
    (<Link href={href}>
      <motion.div
        ...
        className={cn(
          "aspect-square rounded-full bg-neutral-800 flex items-center justify-center relative",
